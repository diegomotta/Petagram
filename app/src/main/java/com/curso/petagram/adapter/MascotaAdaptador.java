...
public class MascotaAdaptador extends RecyclerView.Adapter<MascotaAdaptador.MascotaViewHolder> {
    ...
    public MascotaAdaptador(Context context , ArrayList<Mascota> mascotas, ArrayList<Mascota> mascotasFavoritas) {
    ...
    public void onBindViewHolder(final MascotaViewHolder mascotaViewHolder, final int position) {
        ...
        picasso.load(mascota.getFoto()).fit().into(mascotaViewHolder.foto);
